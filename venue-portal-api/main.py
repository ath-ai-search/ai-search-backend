...
def overview(authorization: Optional[str] = Header(None)):
    ...
    return {
        ...
        "ai_cost_month": round(est["total_cost"] + PLAN_FEE_MONTHLY, 3),
...
def _analytics_data(source: str = "all", size: int = 30, days: int = 0):
    ...
    return {
        ...
        "ai_calls": total,
        "cost": round(PLAN_FEE_MONTHLY + total * per_search_cost, 3),
        "clicks": clicks,
        "orders": orders,
...
def stats(client_id: str = "default"):
    ...
    return {"indexed": n, "source_total": max(INDEX_TARGET, n), "failed": 0,
            ...
            "ai": {"model": "text-embedding-3-large",
                   ...
                   "cost": round(est["total_cost"] + PLAN_FEE_MONTHLY, 3),
                   "total_cost": round(est["total_cost"] + PLAN_FEE_MONTHLY, 3),
